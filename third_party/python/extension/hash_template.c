...
#define _ALG_NAME _XSTR(ALG_NAME)
#define _ALG_NAME_LOWER _XSTR(ALG_NAME_LOWER)
...
"new([string]): Return a new " _ALG_NAME
...
_MODULE_NAME (void)
{
	...
	/* m = Py_InitModule("pyutil.hasher." _MODULE_STRING, ALG_functions); */

	m = Py_InitModule3(_MODULE_STRING, ALG_functions,
					   "An implementation of the " _ALG_NAME
					   " hash function."
					   );
